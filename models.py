...
class schedule(db.Model):
    ...
    schedule_class_date = db.Column('schedule_date', db.DateTime, default=datetime.utcnow)
    schedule_milestone = db.Column('schedule_milestone', db.DateTime, default=datetime.utcnow)
...
class fyp(db.Model):
    ...
    schedule_id =db.Column('schedule_id', db.Integer, db.ForeignKey('schedule.schedule_id'), nullable=False)
